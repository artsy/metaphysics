...
export default {
  BIDDER_POSITION_MAX_BID_AMOUNT_CENTS_LIMIT:
    Number(BIDDER_POSITION_MAX_BID_AMOUNT_CENTS_LIMIT) || Number.MAX_SAFE_INTEGER,
  ...
  DIFFUSION_API_BASE,
  DIFFUSION_TOKEN,
  DIFFUSION_REQUEST_THROTTLE_MS: Number(DIFFUSION_REQUEST_THROTTLE_MS) || 600000, // 5 minutes
  EMBEDLY_ENDPOINT,
  EMBEDLY_KEY,
  ENABLE_ASYNC_STACK_TRACES,
  ENABLE_QUERY_TRACING,
