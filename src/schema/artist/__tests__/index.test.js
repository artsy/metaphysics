...
describe("Artist type", () => {
  ...
  it("returns null for an empty ID string", () => runQuery("{ artist(id: \"\") { id } }", rootValue).then((data) => {
      expect(data.artist).toBe(null)
    }))

  it("fetches an artist by ID", () => runQuery("{ artist(id: \"foo-bar\") { id, name } }", rootValue).then((data) => {
