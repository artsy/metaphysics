...
export const BiddingMessages = [
  {
    ...
    description_md: () =>
      {return "Another bidder placed a higher max bid or the same max bid before you did.  \
 Bid again to take the lead."},
  },
  {
    ...
    header: "Your bid wasn't high enough",
    description_md: () =>
      {return "Your bid didn’t meet the reserve price for this work.  \
 Bid again to take the lead."},
  },
  {
    id: "SALE_CLOSED",
    ...
    header: "Lot closed",
    description_md: () =>
      {return "Sorry, your bid wasn’t received before the lot closed."},
  },
  {
    id: "LIVE_BIDDING_STARTED",
    gravity_key: "Live Bidding has Started",
    header: "Live bidding has started",
    description_md: params => {return `Sorry, your bid wasn’t received before live bidding started.\
 To continue bidding, please [join the live auction](${
  ...
  },
  {
    ...
    description_md: () =>
      {return "Your bid can’t be placed at this time.\
