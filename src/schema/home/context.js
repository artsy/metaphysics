...
export const HomePageModuleContextTrendingType = create(Trending.type, {
  ...
  isTypeOf: ({ context_type }) => {return context_type === "Trending"},
})
...
export const HomePageModuleContextFollowArtistsType = create(
  FollowArtists.type,
  {
    ...
    isTypeOf: ({ context_type }) => {return context_type === "FollowArtists"},
  }
)
...
export const HomePageModuleContextRelatedArtistType = new GraphQLObjectType({
  ...
  isTypeOf: ({ context_type }) => {return context_type === "RelatedArtist"},
})
...
export const HomePageModuleContextFollowedArtistType = new GraphQLObjectType({
  ...
  isTypeOf: ({ context_type }) => {return context_type === "FollowedArtist"},
})
...
export const moduleContext = {
  ...
  followed_galleries: () => {return null},
  saved_works: () => {return null},
  recently_viewed_works: () => {return null},
  similar_to_recently_viewed: () => {return null},
  similar_to_saved_works: () => {return null},
  recommended_works: () => {return null},
