...
export const FeaturedLinkItemType = _.create(FeaturedLink.type, {
  ...
  isTypeOf: ({ item_type }) => {return item_type === "FeaturedLink"},
})

export const ArtistItemType = _.create(Artist.type, {
  name: "ArtistItem",
  isTypeOf: ({ item_type }) => {return item_type === "Artist"},
})

export const ArtworkItemType = _.create(Artwork.type, {
  name: "ArtworkItem",
  isTypeOf: ({ item_type }) => {return item_type === "Artwork"},
})

export const GeneItemType = _.create(Gene.type, {
  name: "GeneItem",
  isTypeOf: ({ item_type }) => {return item_type === "Gene"},
})
