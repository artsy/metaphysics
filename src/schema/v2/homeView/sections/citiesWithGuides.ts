export interface CityWithGuide {
  slug: string
  name: string
...
export const CITIES_WITH_GUIDES = [
  {
  ...
  },
  {
    ...
    maxBounds: {
      sw: { lat: 25.131, lng: -80.887 },
      ne: { lat: 26.386, lng: -79.493 },
    },
  },
  {
    ...
    maxBounds: {
      sw: { lat: 37.19, lng: -123.152 },
      ne: { lat: 38.347, lng: -121.688 },
    },
  },
  {
    slug: "hong-kong-hong-kong",
    name: "Hong Kong",
    coordinates: { lat: 22.28, lng: 114.16 },
    maxBounds: {
      sw: { lat: 21.64, lng: 113.47 },
      ne: { lat: 22.918, lng: 114.85 },
    },
  },
  {
    slug: "milan-italy",
    ...
    maxBounds: {
      sw: { lat: 44.929, lng: 8.412 },
      ne: { lat: 46.006, lng: 9.948 },
    },
  },
  {
    ...
    maxBounds: {
      sw: { lat: -24.194, lng: -47.333 },
      ne: { lat: -22.924, lng: -45.947 },
    },
  },
  {
    slug: "tokyo-japan",
    ...
    maxBounds: {
      sw: { lat: 35.1, lng: 138.966 },
      ne: { lat: 36.276, lng: 140.414 },
    },
  },
  {
    slug: "toronto-canada",
    ...
    maxBounds: {
      sw: { lat: 43.099, lng: -80.138 },
      ne: { lat: 44.196, lng: -78.622 },
    },
  },
  {
    ...
    maxBounds: {
      sw: { lat: 18.782, lng: -99.816 },
      ne: { lat: 20.076, lng: -98.444 },
    },
  },
  {
    slug: "brussels-belgium",
    name: "Brussels",
    coordinates: { lat: 50.85, lng: 4.36 },
    maxBounds: {
      sw: { lat: 50.228, lng: 3.374 },
      ne: { lat: 51.474, lng: 5.35 },
    },
  },
  {
    ...
    maxBounds: {
      sw: { lat: 0.608, lng: 103.178 },
      ne: { lat: 1.952, lng: 104.522 },
    },
  },
  {
    ...
    maxBounds: {
      sw: { lat: 40.827, lng: 1.423 },
      ne: { lat: 41.948, lng: 2.917 },
    },
  },
  {
    ...
    maxBounds: {
      sw: { lat: -34.514, lng: 17.702 },
      ne: { lat: -33.322, lng: 19.138 },
    },
  },
  {
    ...
    maxBounds: {
      sw: { lat: -34.465, lng: 150.492 },
      ne: { lat: -33.272, lng: 151.928 },
    },
  },
  {
    ...
    maxBounds: {
      sw: { lat: 40.446, lng: 28.234 },
      ne: { lat: 41.57, lng: 29.726 },
    },
  },
  {
    ...
    maxBounds: {
      sw: { lat: 24.569, lng: 54.574 },
      ne: { lat: 25.828, lng: 55.966 },
    },
  },
  {
    ...
    maxBounds: {
      sw: { lat: 36.989, lng: 126.249 },
      ne: { lat: 38.148, lng: 127.711 },
    },
  },
  {
    ...
    maxBounds: {
      sw: { lat: -35.191, lng: -59.101 },
      ne: { lat: -34.005, lng: -57.659 },
    },
  },
  {
    slug: "montreal-canada",
    name: "Montreal",
    coordinates: { lat: 45.5, lng: -73.57 },
    maxBounds: {
...
export type CityWithGuideSlug = typeof CITIES_WITH_GUIDES[number]["slug"]
