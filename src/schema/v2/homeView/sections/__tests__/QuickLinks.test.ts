...
import { QUICK_LINKS_V2 } from "../QuickLinks"
...
describe("QuickLinks", () => {
  ...
  describe("When a quick link specifies a minimum Eigen version", () => {
    ...
    beforeAll(() => QUICK_LINKS_V2.push(versionedQuickLink))
    afterAll(() => QUICK_LINKS_V2.pop())
