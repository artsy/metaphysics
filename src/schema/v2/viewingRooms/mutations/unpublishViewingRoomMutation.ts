...
const SuccessType = new GraphQLObjectType<any, ResolverContext>({
  name: "UnpublishViewingRoomSuccess",
...
const FailureType = new GraphQLObjectType<any, ResolverContext>({
  name: "UnpublishViewingRoomFailure",
...
const ResponseOrErrorType = new GraphQLUnionType({
  name: "UnpublishViewingRoomResponseOrError",
...
>({
  ...
  outputFields: {
    viewingRoomOrError: {
      ...
      description:
        "On success: the unpublished viewing room. On error: the error that occurred.",
      resolve: (result) => result,
    },
    viewingRoom: {
