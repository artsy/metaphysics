/**
 * Editorial data: Gravity stores no neighborhoods, so these tables map postcode prefixes,
 * derived from show addresses, to City Guide neighborhoods. Keyed by City Guide city slug.
 */
...
export const CITY_NEIGHBORHOODS: Record<string, CityNeighborhoodDef[]> = {
  "london-united-kingdom": [
    {
      id: "mayfair",
      title: "Mayfair",
      postalPrefixes: ["W1B", "W1J", "W1K", "W1S"],
    },
    ...
    },
    {
      ...
      postalPrefixes: ["W1", "SW1", "WC1", "WC2"],
    },
    { id: "farringdon", title: "Farringdon", postalPrefixes: ["EC1"] },
    {
      id: "east-london",
      title: "East London",
      postalPrefixes: ["E1", "E2", "E8", "E9", "EC2"],
    },
    {
      id: "north-london",
      title: "North London",
  ...
  "new-york-ny-usa": [
    { id: "chelsea", title: "Chelsea", postalPrefixes: ["10001", "10011"] },
    {
      ...
      postalPrefixes: ["10002"],
    },
    {
      id: "east-village",
      title: "East Village",
      postalPrefixes: ["10003", "10009"],
    },
  ...
  "los-angeles-ca-usa": [
    ...
    { id: "arts-district", title: "Arts District", postalPrefixes: ["90021"] },
    {
      id: "hollywood",
      title: "Hollywood",
      postalPrefixes: ["90004", "90028", "90029", "90038"],
    },
    {
    ...
    },
    {
      ...
      postalPrefixes: ["90046", "90048", "90069"],
    },
    ...
    },
    {
      id: "west-adams",
      title: "West Adams",
      postalPrefixes: ["90016", "90018"],
    },
    {
      id: "culver-city",
      title: "Culver City",
      postalPrefixes: ["90034", "90230", "90232"],
    },
  ...
  "berlin-germany": [
    ...
    {
      id: "wedding-moabit",
      title: "Wedding & Moabit",
      postalPrefixes: ["105", "133"],
    },
  ],
  "miami-fl-usa": [
    ...
    { id: "allapattah", title: "Allapattah", postalPrefixes: ["33142"] },
    {
      ...
      postalPrefixes: ["33137"],
    },
    {
      id: "little-river",
      title: "Little River",
      postalPrefixes: ["33138", "33150"],
    },
    {
      id: "downtown-miami",
    ...
    },
    {
      id: "miami-beach",
      title: "Miami Beach",
      postalPrefixes: ["33139", "33140", "33141"],
    },
    {
      id: "north-miami",
      title: "North Miami",
      postalPrefixes: ["33161", "33181"],
    },
  ],
  "san-francisco-ca-usa": [
    ...
    {
      id: "dogpatch",
      title: "Dogpatch & Potrero Hill",
      postalPrefixes: ["94107", "94158"],
    },
  ...
  "milan-italy": [
    {
      id: "centro-brera",
      title: "Centro & Brera",
      postalPrefixes: ["20121", "20122", "20123"],
    },
    {
      id: "porta-venezia",
      title: "Porta Venezia",
      postalPrefixes: ["20124", "20129"],
    },
    {
      id: "porta-volta",
      title: "Porta Volta & Sempione",
      postalPrefixes: ["20154"],
    },
    {
      id: "citylife-fiera",
  ...
  "tokyo-japan": [
    {
      ...
      postalPrefixes: ["103", "104"],
    },
    {
      id: "roppongi",
      title: "Roppongi & Minato",
      postalPrefixes: ["105", "106", "107", "108"],
    },
    { id: "shibuya", title: "Shibuya", postalPrefixes: ["150", "151"] },
    {
      id: "tennozu",
      title: "Tennozu",
      postalPrefixes: ["140-0002", "1400002"],
    },
  ],
  "toronto-canada": [
    {
    ...
    {
      id: "king-west",
      title: "King West & Queen West",
      postalPrefixes: ["M5V", "M6J"],
    },
    {
      id: "junction-triangle",
      title: "Junction Triangle",
      postalPrefixes: ["M6P"],
    },
  ],
  "mexico-city-mexico": [
    { id: "roma", title: "Roma", postalPrefixes: ["06700", "06760"] },
    {
      id: "condesa",
      title: "Condesa",
      postalPrefixes: ["06100", "06140", "06170"],
    },
    {
      id: "san-rafael-juarez",
      title: "San Rafael & Juárez",
      postalPrefixes: ["06470", "06600"],
    },
    {
      id: "polanco",
      title: "Polanco",
  ...
  "singapore-singapore": [
    {
      id: "marina-bay",
      title: "Marina Bay & Downtown",
      postalPrefixes: ["01", "03", "04", "06"],
    },
    {
      id: "chinatown",
      title: "Chinatown & Tanjong Pagar",
      postalPrefixes: ["05", "07", "08"],
    },
    {
      id: "gillman-barracks",
      title: "Gillman Barracks",
      postalPrefixes: ["1089", "10944"],
    },
  ...
  "barcelona-spain": [
    ...
    {
      id: "sant-pere",
      title: "Sant Pere & Trafalgar",
      postalPrefixes: ["08010"],
    },
    {
      id: "eixample",
      title: "Eixample",
  ...
  "cape-town-south-africa": [
    ...
    {
      id: "woodstock",
      title: "Woodstock & Salt River",
      postalPrefixes: ["7915", "7925"],
    },
  ],
  "istanbul-turkiye": [
    {
      id: "beyoglu",
      title: "Beyoğlu & Karaköy",
      postalPrefixes: ["3442", "3443", "3444"],
    },
    {
      id: "nisantasi",
      title: "Nişantaşı & Harbiye",
      postalPrefixes: ["34365", "34367"],
    },
  ],
  ...
  "seoul-south-korea": [
    ...
    {
      id: "mapo",
      title: "Hongdae & Yeonnam",
      postalPrefixes: ["039", "040", "041"],
    },
  ...
  "paris-france": [
    ...
    {
      id: "paris-16",
      title: "16th arrondissement",
      postalPrefixes: ["75016", "75116"],
    },
