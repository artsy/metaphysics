  ...
  describe("#artistDocumentsConnection", () => {
    ...
    beforeEach(() => {
      ...
      context = {
        ...
        partnerArtistDocumentsLoader: () => {
          return Promise.resolve({
            body: artistDocumentsResponse,
            headers: {
              "x-total-count": artistDocumentsResponse.length,
            },
          })
        },
      }
    ...
    it("returns artist documents", async () => {
      const query = gql`
        {
          partner(id: "bastian") {
            artistDocumentsConnection(artistID: "artistID", first: 5) {
              edges {
                node {
                  filename
                  title
    ...
    it("returns hasNextPage=true when first is below total", async () => {
      const query = gql`
        {
          partner(id: "bastian") {
            artistDocumentsConnection(artistID: "artistID", first: 1) {
              pageInfo {
                hasNextPage
              }
            }
    ...
    it("returns hasNextPage=false when first is above total", async () => {
      const query = gql`
        {
          partner(id: "bastian") {
            artistDocumentsConnection(artistID: "artistID", first: 3) {
              pageInfo {
                hasNextPage
              }
            }
