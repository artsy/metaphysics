  ...
  describe("resizedImageUrl", () => {
    describe("landscape input", () => {
      ...
      it("takes an image response with options and resizes it to fit (landscape)", () => {
        const url1x =
          "https://gemini.cloudfront.test?height=333&quality=85&resize_to=fit&src=https%3A%2F%2Fxxx.cloudfront.net%2Fxxx%2Flarge.jpg&width=500"
        const url2x =
          "https://gemini.cloudfront.test?height=666&quality=85&resize_to=fit&src=https%3A%2F%2Fxxx.cloudfront.net%2Fxxx%2Flarge.jpg&width=1000"
      ...
      it("takes an image response with options and resizes it to fit (square)", () => {
        const url1x =
          "https://gemini.cloudfront.test?height=199&quality=85&resize_to=fit&src=https%3A%2F%2Fxxx.cloudfront.net%2Fxxx%2Flarge.jpg&width=300"
        const url2x =
          "https://gemini.cloudfront.test?height=398&quality=85&resize_to=fit&src=https%3A%2F%2Fxxx.cloudfront.net%2Fxxx%2Flarge.jpg&width=600"
    ...
    describe("portrait input", () => {
      ...
      it("takes an image response with options and resizes it to fit (landscape)", () => {
        const url1x =
          "https://gemini.cloudfront.test?height=500&quality=85&resize_to=fit&src=https%3A%2F%2Fxxx.cloudfront.net%2Fxxx%2Flarge.jpg&width=333"
        const url2x =
          "https://gemini.cloudfront.test?height=1000&quality=85&resize_to=fit&src=https%3A%2F%2Fxxx.cloudfront.net%2Fxxx%2Flarge.jpg&width=666"
      ...
      it("takes an image response with options and resizes it to fit (square)", () => {
        const url1x =
          "https://gemini.cloudfront.test?height=300&quality=85&resize_to=fit&src=https%3A%2F%2Fxxx.cloudfront.net%2Fxxx%2Flarge.jpg&width=199"
        const url2x =
          "https://gemini.cloudfront.test?height=600&quality=85&resize_to=fit&src=https%3A%2F%2Fxxx.cloudfront.net%2Fxxx%2Flarge.jpg&width=398"
      ...
      it("takes an image response with options (just one dimension) and resizes it to fit", () => {
        const url1x =
          "https://gemini.cloudfront.test?height=750&quality=85&resize_to=fit&src=https%3A%2F%2Fxxx.cloudfront.net%2Fxxx%2Flarge.jpg&width=499"
        const url2x =
          "https://gemini.cloudfront.test?height=1500&quality=85&resize_to=fit&src=https%3A%2F%2Fxxx.cloudfront.net%2Fxxx%2Flarge.jpg&width=998"
      ...
      it("accepts and returns a cachePolicy argument", () => {
        const url1x =
          "https://gemini.cloudfront.test?cache_policy=short&height=750&quality=85&resize_to=fit&src=https%3A%2F%2Fxxx.cloudfront.net%2Fxxx%2Flarge.jpg&width=499"
        const url2x =
          "https://gemini.cloudfront.test?cache_policy=short&height=1500&quality=85&resize_to=fit&src=https%3A%2F%2Fxxx.cloudfront.net%2Fxxx%2Flarge.jpg&width=998"
    ...
    it("returns a resized image URL when existing image dimensions are lacking", () => {
      const url1x =
        "https://gemini.cloudfront.test?height=500&quality=85&resize_to=fit&src=https%3A%2F%2Fxxx.cloudfront.net%2Fxxx%2Flarge.jpg&width=500"
      const url2x =
        "https://gemini.cloudfront.test?height=1000&quality=85&resize_to=fit&src=https%3A%2F%2Fxxx.cloudfront.net%2Fxxx%2Flarge.jpg&width=1000"
