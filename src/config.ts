...
const {
  ...
  ENABLE_LAZY_TOTAL_COUNT,
  ENABLE_METRICS,
  ENABLE_NEW_WORKS_FOR_YOU_GRAVITY,
  ENABLE_QUERY_TRACING,
  ENABLE_REQUEST_LOGGING,
  ENABLE_RESOLVER_BATCHING,
  ENABLE_SALE_ARTWORK_REQUEST_BATCHING,
  EXCHANGE_API_BASE,
  EXCHANGE_APP_ID,
  FORCE_URL,
  GALAXY_API_BASE,
...
export default {
  ...
  ENABLE_LAZY_TOTAL_COUNT: ENABLE_LAZY_TOTAL_COUNT === "true",
  ENABLE_METRICS,
  ENABLE_GEOLOCATION_LOGGING: ENABLE_GEOLOCATION_LOGGING === "true",
  ENABLE_NEW_WORKS_FOR_YOU_GRAVITY: ENABLE_NEW_WORKS_FOR_YOU_GRAVITY === "true",
  ENABLE_QUERY_TRACING,
  ENABLE_REQUEST_LOGGING,
  ENABLE_RESOLVER_BATCHING: ENABLE_RESOLVER_BATCHING === "true",
  ENABLE_SALE_ARTWORK_REQUEST_BATCHING:
    ENABLE_SALE_ARTWORK_REQUEST_BATCHING === "true",
  FORCE_URL,
  GALAXY_API_BASE,
  GALAXY_TOKEN,
  GEMINI_API_BASE,
  ...
  HOME_VIEW_RESOLVER_TIMEOUT_MS: Number(HOME_VIEW_RESOLVER_TIMEOUT_MS) || 4000,
  IMPULSE_API_BASE,
  IMPULSE_APPLICATION_ID,
  INTROSPECT_TOKEN,
