...
export default {
  ...
  EXCHANGE_APP_ID,
  SERVERLESS_IMAGE_ORIGINALS_BUCKET:
    SERVERLESS_IMAGE_ORIGINALS_BUCKET || "artsy-media-assets",
  SERVERLESS_IMAGE_ORIGINALS_CDN:
    SERVERLESS_IMAGE_ORIGINALS_CDN || "https://d32dm0rphc51dk.cloudfront.net",
  SERVERLESS_IMAGE_RESIZING_URL:
    SERVERLESS_IMAGE_RESIZING_URL || "https://d1j88w5k23s1nr.cloudfront.net",
  SERVERLESS_IMAGE_RESIZING_WEIGHT:
    Number(SERVERLESS_IMAGE_RESIZING_WEIGHT) || 0,
