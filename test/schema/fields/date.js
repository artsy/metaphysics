...
describe("date", () => {
  ...
  it("returns unformmated, local time if no format is specified", () => {
    expect(date(rawDate, null, "America/Boise")).toBe("2020-12-31T05:00:00-07:00")
    expect(date(rawDate, null, "Pacific/Fiji")).toBe("2021-01-01T01:00:00+13:00")
  })

  it("provides formatted, local time if timezone and format are specified", () => {
    expect(date(rawDate, format, "America/Boise")).toBe("12/31/2020 5:00 -07:00")
