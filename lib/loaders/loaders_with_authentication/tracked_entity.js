 ...
 * @param {*} paramKey the key that’s to be used for the list of IDs param that’s sent with the API request
 * @param {*} trackingKey the key that’s to be used for this entity, e.g. `is_followed` or `is_saved`.
 * @param {*} entityKeyPath an optional path to a nested entity
 */
