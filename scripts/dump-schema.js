...
graphql(schema, introspectionQuery)
  .then(result => fs.writeFileSync(path.join(destination, "schema.json"), JSON.stringify(result, null, 2)))
  .catch(error => console.error("ERROR introspecting schema: ", JSON.stringify(error, null, 2)))
